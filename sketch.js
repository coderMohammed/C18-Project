...
function createCash() {
  ...
  var cash = createSprite(Math.round(random(50, width-25),40, 10, 10));
...
function createDiamonds() {
  ...
  var diamonds = createSprite(Math.round(random(50,width-25),40, 10, 10));
...
function createJwellery() {
  ...
  var jwellery = createSprite(Math.round(random(50, width-25),40, 10, 10));
